                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="15_blog_details.html">{{$therd_post->title}}</a>
                                    </h2>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$SportsGaming->name}}</h4>
                    ...
                    @foreach($SportsGaming->Posts()->take(3)->get() as $sg)
                        
                        <div class="case-item-wrap">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{asset('/'. $sg->featured)}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="#">{{$sg->title}}</a></h6>
                                </div>
                            </div>
                    @endforeach
