            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-content">
                        ...
                        <!-- exple dyal relation entre 3 dyal les table ORM -->
                        <p class="text">{{$post->user->profile->about}} 
                        </p>
                        <div class="socials">

                            <a href="{{$post->user->profile->facebook}}" class="social__item" target="_blanck">
                    <img src="{{asset('app/svg/circle-facebook.svg')}}" alt="facebook">
                            ...
                            <a href="{{$post->user->profile->youtube}}" class="social__item" target="_blanck">
